        ...
        while (pilihan != 5) {
            ...
            if (pilihan == 1) {
                ...
                while (tambahLagi.equalsIgnoreCase("y")) {
                    ...
                    // MENGGUNAKAN FUNGSI OVERLOADING
                    resepBaru.tambahBahan(namaBahan); 
                ...
                if (daftarResep.isEmpty()) {
                    ...
                    for (Resep r : daftarResep) {
                        ...
                        // Memanggil method yang berasal dari implementasi Interface
                        r.tampilkanLevelKesulitan();
                        System.out.println("Rekomendasi Pemula: " + (r.isRekomendasiPemula() ? "Ya" : "Tidak"));
                ...
                for (Resep r : daftarResep) {
                    if (r.getId() == cariId) {
                        ...
                        if(input.nextLine().equalsIgnoreCase("y")) {
                            r.getListBahan().clear(); // Hapus bahan lama
                            String tambahLagi = "y";
                            while (tambahLagi.equalsIgnoreCase("y")) {
